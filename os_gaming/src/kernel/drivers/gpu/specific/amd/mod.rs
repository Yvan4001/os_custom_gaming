...
pub fn convert_error(error: common::AmdGpuError) -> GpuError {
    match error {
        common::AmdGpuError::CommunicationError => GpuError::CommunicationError,
        ...
        common::AmdGpuError::OutOfMemory => GpuError::OutOfMemory,
        common::AmdGpuError::InvalidParameter => GpuError::InvalidParameter,
        common::AmdGpuError::TextureFailed => GpuError::TextureCreationFailed,
        common::AmdGpuError::DisplayModeFailed => GpuError::DisplayModeFailed,
        common::AmdGpuError::NotInitialized => GpuError::NotInitialized,
        common::AmdGpuError::OperationFailed => GpuError::OperationFailed,
    }
}
